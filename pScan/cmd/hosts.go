...
var hostsCmd = &cobra.Command{
	...
	Long: `Manages the hosts lists for pScan
		   Add hosts with the add command Delete hosts with
	 	   the delete command List hosts with the list command.`,
...
// instance rootCmd to attach the hostsCmd command to the root.
func init() {
